...
class Formulario(FlaskForm):
    ...
    tipoCortina =  SelectField('Tipo Cortina', choices=[('oxford','Oxford'), ('tergal','Tergal'), ('gabardine', 'Gabardine')])
...
def home():
    ...
    if formulario.validate_on_submit():
        ...
        return "Largura: " + str(largura) +" Altura: " + str(altura) + " Tipo de Cortina " + str(tipoCortina)+" Valor: R$"+str(altura*largura*83)
